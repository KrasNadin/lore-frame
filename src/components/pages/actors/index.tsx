				...
				<Space direction='vertical' size='middle' style={{ width: '100%' }}>
					...
					<Flex className='actor-layout' gap='middle' wrap='wrap' align='stretch'>
						...
						<Alert
							...
							description='Актёры — это персонажи игроков, союзники, враги и все те, кто имеет имя и внешний вид. Загрузите изображение, дайте имя — и мы сгенерируем их описание. Важно! Иногда нейросеть отказывается это делать. Вы можете попробовать заставить ее или описать персонажа самостоятельно.'
							closable
						/>
					</Flex>
